...
var validation$z = {
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 == 0 && max3) {
      return `${sentence(name)} ha de ser inferior o igual a ${max3} car\xE0cters.`;
    }
    if (min3 === max3) {
      return `${sentence(name)} ha de tenir una longitud de ${max3} car\xE0cters.`;
    }
    if (min3 && max3 === Infinity) {
      return `${sentence(name)} ha de ser major que o igual a ${min3} car\xE0cters.`;
    }
    return `${sentence(name)} ha d'estar entre ${min3} i ${max3} car\xE0cters.`;
  },
  matches({ name }) {
  ...
  starts_with({ name, args }) {
    return `${sentence(name)} no comen\xE7a amb ${list2(args)}.`;
  },
  url() {
...
var validation$y = {
  ...
  ends_with({ name, args }) {
    return `${sentence(name)} nekon\u010D\xED na ${list2(args)}.`;
  },
  is({ name }) {
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 === max3) {
      return `${sentence(name)} by m\u011Blo b\xFDt ${max3} znak\u016F dlouh\xE9.`;
    }
    if (min3 && max3 === Infinity) {
  ...
  starts_with({ name, args }) {
    return `${sentence(name)} neza\u010D\xEDn\xE1 na ${list2(args)}.`;
  },
  url() {
...
var validation$x = {
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 === max3) {
      return `${sentence(name)} skal v\xE6re ${max3} tegn lange.`;
    }
    if (min3 && max3 === Infinity) {
...
var validation$r = {
  ...
  ends_with({ name, args }) {
    return `${sentence(name)} tulee p\xE4\xE4tty\xE4 ${list2(args)}.`;
  },
  is({ name }) {
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 === max3) {
      return `${sentence(name)} pit\xE4isi olla ${max3} merkki\xE4 pitk\xE4.`;
    }
    if (min3 && max3 === Infinity) {
...
var validation$q = {
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 === max3) {
      return `${sentence(name)} doit contenir ${max3} caract\xE8res.`;
    }
    if (min3 && max3 === Infinity) {
...
var validation$p = {
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 === max3) {
      return `${sentence(name)} moat ${max3} tekens lang w\xEAze.`;
    }
    if (min3 && max3 === Infinity) {
...
var validation$m = {
  ...
  ends_with({ name, args }) {
    return `${sentence(name)} mez\u0151 nem a kijel\xF6lt (${list2(args)}) m\xF3don \xE9r v\xE9get.`;
  },
  is({ name }) {
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 === max3) {
      return `${sentence(name)} ${max3} karakter hossz\xFAnak kell lennie.`;
    }
    if (min3 && max3 === Infinity) {
  ...
  starts_with({ name, args }) {
    return `${sentence(name)} nem a k\xF6vetkez\u0151vel kezd\u0151dik: ${list2(args)}.`;
  },
  url() {
...
var validation$g = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} m\xE5 v\xE6re senere enn ${date2(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} m\xE5 v\xE6re tidligere enn ${date2(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} m\xE5 v\xE6re mellom ${date2(args[0])} og ${date2(args[1])}`;
  },
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 == 0 && max3) {
      return `${sentence(name)} m\xE5 ha mindre enn eller n\xF8yaktig ${max3} tegn.`;
    }
    if (min3 === max3) {
      return `${sentence(name)} skal v\xE6re ${max3} tegn langt.`;
    }
    if (min3 && max3 === Infinity) {
      return `${sentence(name)} m\xE5 ha mer enn eller n\xF8yaktig ${min3} tegn.`;
    }
    return `${sentence(name)} m\xE5 ha mellom ${min3} og ${max3} tegn.`;
  },
  matches({ name }) {
    return `${sentence(name)} er ikke en tillatt verdi.`;
  },
...
var validation$e = {
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 === max3) {
      return `Pole ${sentence(name)} musi mie\u0107 ${min3} znak\xF3w.`;
    }
...
var validation$d = {
  ...
  ends_with({ name, args }) {
    return `${sentence(name)} n\xE3o termina com ${list2(args)}.`;
  },
  is({ name }) {
  ...
  starts_with({ name, args }) {
    return `${sentence(name)} n\xE3o come\xE7a com ${list2(args)}.`;
  },
  url() {
...
var validation$c = {
  ...
  starts_with({ name, args }) {
    return `${sentence(name)} nu \xEEncepe cu ${list2(args)}.`;
  },
  url() {
...
var validation$a = {
  ...
  date_after({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} mus\xED by\u0165 za ${date2(args[0])}.`;
    }
  ...
  date_before({ name, args }) {
    if (Array.isArray(args) && args.length) {
      return `${sentence(name)} mus\xED by\u0165 pred ${date2(args[0])}.`;
    }
  ...
  date_between({ name, args }) {
    return `${sentence(name)} mus\xED by\u0165 medzi ${date2(args[0])} a ${date2(args[1])}`;
  },
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 == 0 && max3) {
      return `${sentence(name)} mus\xED by\u0165 men\u0161ie alebo rovn\xE9 ako ${max3} znakov.`;
    }
    if (min3 === max3) {
      return `${sentence(name)} by mala ma\u0165 d\u013A\u017Eku ${max3} znakov.`;
    }
    if (min3 && max3 === Infinity) {
      return `${sentence(name)} mus\xED by\u0165 v\xE4\u010D\u0161ie alebo rovn\xE9 ako ${min3} znakov.`;
    }
    return `${sentence(name)} mus\xED by\u0165 medzi ${min3} a\u017E ${max3} znakov.`;
  },
  matches({ name }) {
    return `${sentence(name)} nie je povolen\xE1 hodnota.`;
  },
  ...
  starts_with({ name, args }) {
    return `${sentence(name)} neza\u010D\xEDn\xE1 s ${list2(args)}.`;
  },
  url() {
...
var validation$7 = {
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 === max3) {
      return `${sentence(name)} b\xF6r vara ${max3} tecken l\xE5nga.`;
    }
    if (min3 && max3 === Infinity) {
  ...
  starts_with({ name, args }) {
    return `${sentence(name)} b\xF6rjar inte med ${list2(args)}.`;
  },
  url() {
...
var validation$1 = {
  ...
  ends_with({ name, args }) {
    return `${sentence(name)} kh\xF4ng k\u1EBFt th\xFAc v\u1EDBi ${list2(args)}.`;
  },
  is({ name }) {
  ...
  length({ name, args: [first = 0, second = Infinity] }) {
    ...
    if (min3 === max3) {
      return `${sentence(name)} n\xEAn d\xE0i ${max3} k\xFD t\u1EF1.`;
    }
    if (min3 && max3 === Infinity) {
  ...
  starts_with({ name, args }) {
    return `${sentence(name)} kh\xF4ng b\u1EAFt \u0111\u1EA7u v\u1EDBi ${list2(args)}.`;
  },
  url() {
